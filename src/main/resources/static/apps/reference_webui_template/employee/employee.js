(function() {
	...
	function employeeController($scope, $rootScope, $resource, $http, usSpinnerService, $log) {
		...
		$scope.readAll = function() {
			...
			$http({						
				...
				$scope.postHandle("employee/employee-list.html");
			}).error(function(e) {	
				$scope.postHandle("employee/employee-error.html");
			});	
		...
		$scope.read = function(item) {
			...
			$http({						
				...
				$scope.postHandle("employee/employee-view.html");
			}).error(function(e) {	
				$scope.postHandle("employee/employee-error.html");
			});		
		...
		$scope.createForm = function() {
			...
			$scope.itemResource = {};
			$scope.postHandle("employee/employee-edit.html");	
		}
	...
	angular.module('singApp.employee').controller('employeeController', employeeController);
